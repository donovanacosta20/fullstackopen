...
const Anecdote = ({ anecdoteById }) => {
  ...
  return (
    <div>
      ...
      <p>for more information visit to <a href={anecdote.info}>{anecdote.info}</a></p>
    </div>
  )
}
...
const App = () => {
  ...
  const addNew = (anecdote) => {
    ...
    setNotification(`a new anedocte ${anecdote.content} created!`)
  ...
  return (
    <div>
      ...
      <Router>
        <Menu />
        <Routes>
          <Route path='anecdote/:id' element={<Anecdote anecdoteById={anecdoteById} />} />
